...
public class TGrafoDirigido implements IGrafoDirigido {
    ...
    public TGrafoDirigido(Collection<TVertice> vertices, TAristas aristas) {
        lasAristas = aristas;
    ...
    @Override
    public void listarTareas(LinkedList listaTareas) {
        StringBuilder sb = new StringBuilder();
        sb.append("Inicio -> ");
        for (Object tarea : listaTareas) {
            sb.append(((Tarea) tarea).getNombre() + " -> ");
        }
    ...
    public LinkedList<Tarea> ordenParcial() {
        if (!this.tieneCiclo()) {
            ...
            LinkedList<Tarea> camino = new LinkedList();
            TVertice v = this.buscarVertice("Fin");
            if (!v.getVisitado()) {
    ...
    public boolean tieneCiclo() {
        ...
        for (TVertice v : vertices.values()) {
            if (!v.getVisitado() & v.tieneCiclo(camino)) {
                return true;
            }
        }
        return false;
